...
export const LAUNCH_READINESS_BENCHMARKS: LaunchBenchmarkCase[] = [
  {
    ...
    nonNegotiableQualityCriteria: [
      ...
      "Opening sounds like a real teacher replying, not a complaint desk.",
    ...
    obviousFailurePatterns: [
      ...
      "Uses stiff or generic greeting forms.",
    ...
    sampleGoodOutput: [
      ...
      "Hello Jordan,",
      "",
      "I'm sorry Theo came home so upset after maths today. I will check the lesson notes this afternoon and speak with him again tomorrow so I can respond to you clearly.",
      "",
  ...
  },
  {
    ...
    nonNegotiableQualityCriteria: [
      ...
      "Uses a natural English greeting when no parent name is available.",
      "Stays concise and sendable.",
    ],
    obviousFailurePatterns: [
      "Starts by thanking the parent for writing.",
      "Uses generic family-address greeting language.",
    ...
    sampleGoodOutput: [
      ...
      "",
      "I have moved her closer to me and started breaking the longer tasks into smaller steps. I will keep the same support in place next week and let you know how she manages with that adjustment.",
      "",
      "Kind regards,",
      "Dr Greg Blackburn",
    ].join("\n"),
  ...
  },
  {
    ...
    sampleGoodOutput: [
      ...
      "Hello Jordan,",
      "",
      "I'm sorry to hear how upsetting this has been for your child. I will review what happened in today's lesson and speak with the students involved so I can respond to you clearly.",
      "",
  ...
  },
  {
    ...
    nonNegotiableQualityCriteria: [
      ...
      "Opening is serious and specific rather than generic or soothing.",
    ...
    sampleGoodOutput: [
      ...
      "Hello,",
      "",
      "I'm sorry to hear that your daughter has been feeling unsafe. I have passed this to our safeguarding lead today so it is reviewed promptly by the appropriate staff.",
      "",
