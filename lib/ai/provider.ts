...
export function buildSystemPrompt(input: ProviderInput) {
  ...
  const systemLines = [
    ...
    "Avoid abstract support-plan phrasing such as 'support his success in the classroom', 'identify specific supports that would be useful', 'additional support strategies', or 'support the overall learning experience'. Prefer plain teacher wording such as 'see what might help', 'work together on ways to support him', 'practical next steps', or 'help him stay settled in class'.",
