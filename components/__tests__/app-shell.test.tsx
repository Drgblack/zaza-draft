...
describe("AppShell layout", () => {
  ...
  it("applies the app theme on editor routes", () => {
    ...
    expect(bgElement.className).toContain("bg-gradient-to-br")
    expect(bgElement.className).toContain("from-rose-500")
    expect(bgElement.className).toContain("via-fuchsia-600")
    expect(bgElement.className).toContain("to-orange-500")
    expect(bgElement.className).toContain("saturate-125")
    expect(bgElement.className).toContain("contrast-110")
