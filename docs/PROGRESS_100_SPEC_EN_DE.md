...
- EN/DE parity: Yes
- v1.0 scope decision: Clients now have scoped read access to their own `users/`, `snippets/`, and `subscriptions/` docs while all other collections remain server-only. Testing harness is deferred, documented in `docs/FIRESTORE_RULES_V1.md`.
