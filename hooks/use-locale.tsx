...
export const localeMessages: Record<Locale, LocaleMessages> = {
  ...
  "de-DE": {
    ...
    "guides.back": "Zurück zum Support",
    "guides.drafting.title": "Tipps zum Entwurf",
    "guides.drafting.intro": "Beginnen Sie mit einer klaren Situation, beschreiben Sie den Einfluss und nennen Sie die nächsten Schritte.",
    "guides.drafting.tip1": "Beginnen Sie mit einer freundlichen Begrüßung und dem Grund für das Schreiben",
    "guides.drafting.tip2": "Fassen Sie beobachtbare Details zusammen, ohne Namen zu nennen",
    "guides.drafting.tip3": "Schließen Sie mit einem konkreten Vorschlag oder Wunsch ab",
    "guides.drafting.examplesTitle": "Beispiel",
    "guides.drafting.example1": "Guten Morgen, mir ist aufgefallen, dass Jamie noch Schwierigkeiten mit Bruchteilen hat.",
    "guides.drafting.example2": "Könnten wir einen kurzen Austausch planen, damit ich die unterstützenden Schritte teile?",
