...
export const localeMessages: Record<Locale, LocaleMessages> = {
  "en-GB": {
    ...
    panicScanResultHelpNote: "Clicking this will open the editor with the extracted message preloaded.",
  ...
  "de-DE": {
    ...
    panicScanResultHelpNote: "Dadurch wird der Editor mit der erkannten Nachricht geöffnet.",
