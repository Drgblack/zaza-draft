...
export const localeMessages: Record<Locale, LocaleMessages> = {
  "en-GB": {
    ...
    "insights.dataControls.privacySettings": "Privacy settings",
      ...
      "editor.notice.scopeGuard.subtext": "This tool only drafts parent messages and report comments.",
  ...
  "de-DE": {
    ...
    "editor.notice.scopeGuard.subtext": "Dieses Tool erstellt nur Elternnachrichten und Zeugniskommentare.",
