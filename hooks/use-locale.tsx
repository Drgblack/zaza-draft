...
export const localeMessages: Record<Locale, LocaleMessages> = {
  ...
  "de-DE": {
    ...
    "editor.inputMode.parentMessagePromise":
      "Ich formuliere eine Antwort, die ruhig, professionell und schwer misszuverstehen ist.",
    "editor.inputMode.teacherDraftPromise":
      "Ich verbessere deine Nachricht, ohne zu verändern, was du sagen willst.",
