...
export const localeMessages: Record<Locale, LocaleMessages> = {
  ...
  "de-DE": {
    ...
    "support.guides.description": "Entdecken Sie gebündelte Ressourcen, die Familien informieren und Dokumentation fokussieren.",
    "support.guides.button": "Guides ansehen",
    "support.guides.guide1.title": "Vorlagen für Elternkommunikation",
    "support.guides.guide1.description": "Nutzen Sie bewährte Einführungs-, Fortschritts- und Gratulationsnoten ohne komplett neues Schreiben.",
    "support.guides.guide1.step1": "Öffnen Sie das Parent Newsletter Kit",
    "support.guides.guide1.step2": "Wählen Sie den Ton passend zur Klassenkultur",
    "support.guides.guide1.step3": "Passen Sie die Vorlage an das aktuelle Thema an",
    "support.guides.guide2.title": "Routinen & Wohlbefinden",
    "support.guides.guide2.description": "Dokumentieren Sie Verhaltensbeobachtungen, Wohlbefinden und Anwesenheit mit klarer, fürsorglicher Sprache.",
    "support.guides.guide2.step1": "Schauen Sie sich die Wohlfühl-Satzbank an",
    "support.guides.guide2.step2": "Fügen Sie Schüler:innen und Kontext hinzu",
    "support.guides.guide2.step3": "Teilen Sie die Notiz mit Familien oder Kolleg:innen",
    "support.guides.guide3.title": "Lernreflexionen & abteilungsübergreifende Notizen",
    "support.guides.guide3.description": "Halten Sie Erkenntnisse aus Lesen, Mathematik oder Naturwissenschaften mit strukturierten Eingabeaufforderungen fest.",
    "support.guides.guide3.step1": "Nutzen Sie die Outline für Lernbesprechungen",
    "support.guides.guide3.step2": "Nennen Sie nächste Schritte oder Unterstützungsbedarf",
    "support.guides.guide3.step3": "Speichern oder teilen Sie die Notiz",
    "support.guides.helpText": "Lieber direkte Hilfe? Schreiben Sie uns kurz und wir antworten innerhalb eines Arbeitstages in der App.",
    "support.community.title": "Community & Zusammenarbeit",
    "support.community.description": "Teilen Sie Praxisideen, feiern Sie Erfolge und vernetzen Sie sich mit anderen Lehrkräften.",
    "support.community.button": "Zur Community",
    "support.contact.title": "Support kontaktieren",
    "support.contact.description": "Beschreiben Sie den Unterrichtskontext oder die Policy-Frage, bei der Sie Unterstützung brauchen.",
    "support.contact.subjectLabel": "Betreff",
    "support.contact.subjectPlaceholder": "Kurze Zusammenfassung (z. B. 'Frage zur Draft Scope')",
    "support.contact.detailsLabel": "Details",
    "support.contact.detailsPlaceholder": "Teilen Sie Kontext, Zeitplan oder Richtlinienfrage mit, bei der Sie Hilfe brauchen.",
    "support.contact.helper": "Sagen Sie uns, wie Zaza Draft Sie unterstützen kann und für welches Jahrgangsniveau.",
    "support.contact.sending": "Wird gesendet...",
    "support.contact.button": "Anfrage senden",
    "support.contact.submitted": "Danke! Unser Team meldet sich innerhalb eines Arbeitstages in der App.",
    "support.contact.submittedMessage": "Wir haben Ihre Anfrage erhalten! Sie können diesen Tab schließen oder zum Hilfe-Überblick zurückkehren.",
