...
export const localeMessages: Record<Locale, LocaleMessages> = {
  "en-GB": {
    ...
    emptyLessonPlan: "Start planning your lesson â€” Zara will help you structure and refine as you go.",
    emptyEmail: "Draft your email â€” Zara will help you strike the right tone and clarity.",
    emptyReport: "Begin your report â€” Zara will help you stay clear and evidence-based.",
    emptyGeneral: "Start writing â€” Zara will help polish your words when you're ready.",
    ...
    noDraftsYet: "No drafts yet â€” create your first document.",
    ...
    "panel.title": "Zara â€” your writing helper",
    ...
    "panel.progress.polishing": "You're polishing like a pro âœ¨",
    ...
    "insights.heatmap.insight": "Tuesday afternoons are your peak productivity timeâ€”consider blocking that time!",
  ...
  "de-DE": {
    ...
    "panel.title": "Zara â€” Ihr Schreibhelfer",
    ...
    "panel.progress.polishing": "Du polierst wie ein Profi âœ¨",
    ...
    "tone.empathetic": "Empathisch und unterstÃ¼tzend",
    "button.generate": "Entwurf generieren",
    "zara.greeting": "Hallo! Ich bin Zara, deine KI-Lehrassistenz.",
    "zara.description": "Ich kann dir bei Kommunikationstipps und pÃ¤dagogischer Anleitung helfen.",
    ...
    "insights.heatmap.insight":
      "Dienstagnachmittage sind Ihre produktivste Zeit â€“ erwÃ¤gen Sie, diese Zeit zu blockieren!",
    ...
    "wellbeing.tip.default": "Tipp: Beginnen Sie mit dem Ton â€žEinfÃ¼hlsamâ€œ, um Wiederholungen zu vermeiden.",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = useCallback(
    (key: string, vars?: Record<string, string | number>): string => {
      ...
      const message = (messages as any)[key] ?? (messages as any).ui?.[key] ?? (fallbackMessages as any)[key] ?? (fallbackMessages as any).ui?.[key]
